...
// CapturePieceToHistory is addressed by a move's [piece id][to][captured piece type]
using CapturePieceToHistory = Stats<std::int16_t, 10692, 64, SQUARE_NB, PIECE_TYPE_NB>;
