...
constexpr int NON_PAWN_HISTORY_SIZE    = 2048;  // has to be a power of 2
...
static_assert((NON_PAWN_HISTORY_SIZE & (NON_PAWN_HISTORY_SIZE - 1)) == 0,
              "NON_PAWN_HISTORY_SIZE has to be a power of 2");
...
// NonPawnHistory is addressed by the non-pawn structure and a move's [piece][to]
