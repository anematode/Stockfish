...
// CapturePieceToHistory is addressed by a move's [piece][trajectory][captured piece type]
using CapturePieceToHistory = Stats<std::int16_t, 10692, PIECE_NB, TRAJECTORY_NB, PIECE_TYPE_NB>;
