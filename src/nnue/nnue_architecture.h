...
struct NetworkArchitecture {
    ...
    std::int32_t propagate(const TransformedFeatureType* transformedFeatures, const uint8_t* nnz32) const {
        ...
        fc_0.propagate(transformedFeatures, buffer.fc_0_out, nnz32);
