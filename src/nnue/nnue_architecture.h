...
struct NetworkArchitecture {
    ...
    std::int32_t propagate(const TransformedFeatureType* transformedFeatures, uint16_t nnz_bitset[768 / 16]) {
        ...
        fc_0.propagate(transformedFeatures, buffer.fc_0_out, nnz_bitset);
