        ...
        for (IndexType p = 0; p < 2; ++p)
        {
            ...
            for (IndexType j = 0; j < NumOutputChunks; j += 2)
            {
                ...
                for (IndexType k = 0; k < 2; ++k)
                {
                    ...
                    auto mg1 = __riscv_vcreate_v_i16m1_i16m2(to_rvv(acc0a), to_rvv(acc0b));
                    auto mg2 = __riscv_vcreate_v_i16m1_i16m2(to_rvv(acc1a), to_rvv(acc1b));
                    ...
                    vec_t result =
                      from_rvv(__riscv_vreinterpret_v_u16m1_i16m1(__riscv_vreinterpret_v_u8m1_u16m1(
                        __riscv_vsrl_vx_u8m1(hi, 1, RVV_VLEN / 8))));
    #else
