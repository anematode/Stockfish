...
namespace Stockfish::Eval::NNUE {
    ...
    struct NNZInfo {
        ...
        struct NNZCursor {
            ...
            NNZCursor(NNZInfo& info_, bool perspective, unsigned count_) : info(info_), count(count_) {
        ...
        struct NNZCursor {
            ...
            void record2(SIMD::vec_t neurons1, SIMD::vec_t neurons2) {
                ...
                const uint16x8_t packed = vtrn1q_u16(vreinterpretq_u16_u32(t1), vreinterpretq_u16_u32(t2));
