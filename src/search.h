...
class Worker {
   ...
   private:
    ...
    NO_CLONE Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode);

    // Quiescence search function, which is called by the main search
    template<NodeType nodeType>
    NO_CLONE Value qsearch(Position& pos, Stack* ss, Value alpha, Value beta);
