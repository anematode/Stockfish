...
DEFINE_BUILD(riscv64_gcv_zvl128)
DEFINE_BUILD(riscv64_gcv_zvl256)
DEFINE_BUILD(riscv64_gcv_zvl512)
DEFINE_BUILD(riscv64_gcv_zvl1024)
DEFINE_BUILD(riscv64_gcv_zvl1024plus)
...
static int dispatch(const CpuFeatures& f, int argc, char* argv[]) {
    ...
    {
    case 128 :
        return entry_riscv64_gcv_zvl128(argc, argv);
    case 256 :
        return entry_riscv64_gcv_zvl256(argc, argv);
    case 512 :
        return entry_riscv64_gcv_zvl512(argc, argv);
    case 1024 :
        return entry_riscv64_gcv_zvl1024(argc, argv);
    default :
        return entry_riscv64_gcv_zvl1024plus(argc, argv);
    }
}
